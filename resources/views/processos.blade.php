    ...
    <div class="w3-container">
      ...
      <div class="w3-card-4 ">
        ...
        <ul class="w3-ul">
          <div class="w3-container"><p></p>
            ...
            <div class="w3-col s4">
              <label> Documento:
                <li class="w3-hover">{{$pessoa->cpf_genitor}}</li>
              </label><p></p>
            </div>
          </div> 
        </ul>
      ...
      <div class="w3-card-4">
        <header class="w3-container w3-bar w3-summer-sky">
          ...
          <div class="w3-col s2">
            <button onclick="document.getElementById('id05').style.display='block'" class="w3-button w3-center w3-xlarge w3-fw"> Despacho</button>
          </div>
        </header>
        <div class="w3-container">
          <ul class="w3-ul">
        ...
        <div id="id01" class="w3-modal">
          <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
            ...
            <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
              <button type="button" class="w3-button w3-red">Adicionar</button>
