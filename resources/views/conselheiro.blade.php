  ...
  <div class="w3-col s12 w3-row-padding">
    <table class="w3-card-4 w3-table-all w3-margin-top" id="myTable">
      ...
      <tr>
        ...
        <td>
          <div class="w3-col w3-half" >
            <button class="w3-button" title="Identidade" ><i class="fa fa-info"></i> Identificação</button>
          </div>
          <div class="w3-col w3-half" >
            <button class="w3-button" onclick="document.getElementById('id01').style.display='block'" title="Ver Processo em Aberto" onclick="javascript:location='{{url('/third')}}'" ><i class="fa fa-folder-open"></i> Processos</button>
          </div>
        </td>
      </tr>
      <tr>
